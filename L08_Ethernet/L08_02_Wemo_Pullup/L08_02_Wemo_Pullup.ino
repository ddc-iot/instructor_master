 ...
 * Description: Control smart lighting switch from a button (see NOTE)
 * Author: Brian A Rashap
 * Date: 24-Mar-2020
 */

 // NOTE: for this version, I did not have a pulldown resistor for the button, so used INPUT_PULLUP
 // which required reversing the logic on line 51
